...
# === Webcam ===
if choice == "1":
    cap = cv2.VideoCapture(0)  # <== Webcam máy tính
    if not cap.isOpened():
...
# === Gọi update_encodings.py để tạo/update encodings.pickle ===
...
if result.returncode == 0:
    ...
    print("[ERROR] ❌ Encode thất bại. Kiểm tra file update_encodings.py.")
